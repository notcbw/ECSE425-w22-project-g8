...
proc AddWaves {} {
	...
	add wave -position end sim:/processor/pc_if_to_id
	add wave -position end sim:/processor/i_address
	...
	add wave -position end sim:/processor/rd1_2
	add wave -position end sim:/processor/fwd2
	add wave -position end sim:/processor/rd2_2
	...
	add wave -position end sim:/processor/pc_ex_to_if
	
	add wave -position end sim:/processor/reg_write_m
	add wave -position end sim:/processor/mem_to_reg_m
	add wave -position end sim:/processor/write_reg_m
	add wave -position end sim:/processor/data_m
	add wave -position end sim:/processor/alu_out_m
	add wave -position end sim:/processor/stall_e
	add wave -position end sim:/processor/d_address
	add wave -position end sim:/processor/d_memread
	add wave -position end sim:/processor/d_readdata
	add wave -position end sim:/processor/d_memwrite
	add wave -position end sim:/processor/d_writedata
	add wave -position end sim:/processor/d_waitrequest
	
	add wave -position end sim:/processor/write_reg_w
	add wave -position end sim:/processor/reg_write_w
	add wave -position end sim:/processor/dw
